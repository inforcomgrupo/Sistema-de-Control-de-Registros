...
<div class="filters-bar" id="filtersBarDelegado" style="flex-shrink:0;">
    ...
    <!-- ── NUEVO: fila de filtros dinámicos (campos con mostrar_filtro_delegado = 1) ── -->
    <div class="filters-row" id="delegadoFiltrosDinamicosRow" style="display:none;"></div>
</div>
...
(function () {
    ...
    // =====================================================
    // HEADERS  ── NUEVO: incluye columnas dinámicas con mostrar_lista_delegado
    // =====================================================
    function renderHeaders() {
        ...
        STATE.camposDinamicos.forEach(function (cd) {
            if (cd.mostrar_lista_delegado == 1) {
    ...
    function cargarFiltros() {
        ...
        .then(function (data) {
            if (data.success) {
                ...
                // ── NUEVO: campos dinámicos con mostrar_filtro_delegado = 1
                var camposNuevos = (data.campos_dinamicos || []).filter(function (c) {
                    return c.mostrar_filtro_delegado == 1;
                });
        ...
        }).catch(function (err) { console.error('Error filtros delegado:', err); });
    }
    ...
    // =====================================================
    // CREAR FILA  ── NUEVO: incluye celdas dinámicas con mostrar_lista_delegado
    // =====================================================
